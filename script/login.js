document.addEventListener("DOMContentLoaded", function() {
    ...
    const sampleUsername = "fabricio";
    const samplePassword = "senha1";
    ...
    loginForm.addEventListener("submit", async function(event) {
        ...
        // Verificar se as credenciais correspondem ao usuário e senha de exemplo
        if (username === sampleUsername && password === samplePassword) {
            console.log('Login bem-sucedido com usuário de exemplo');
